"""
Olive Young Price Tracker - Bright Data Web Scraper API
----------------------------------------------------
Track prices, availability, and product data from Olive Young.

Docs  : https://docs.brightdata.co.kr/scraping-automation/web-scraper-api/overview
Info  : https://brightdata.co.kr/products/insights/price-tracker/olive-young
"""
...
# Set your Web Scraper ID after building your Olive Young scraper:
# https://brightdata.co.kr/products/web-scraper/olive-young
DATASET_ID = os.getenv("BRIGHTDATA_DATASET_ID", "")
if not DATASET_ID:
    raise EnvironmentError(
        "BRIGHTDATA_DATASET_ID is not set.\n"
        "1. Build your Olive Young scraper at: https://brightdata.co.kr/products/web-scraper/olive-young\n"
...
def track_prices(urls: list[str], **kwargs) -> list[dict]:
    """
    Collect price data for a list of Olive Young product URLs.
...
def discover_by_keyword(keyword: str, limit: int = 50, **kwargs) -> list[dict]:
    """
    Discover Olive Young products by keyword search.
...
def discover_by_category(category_url: str, limit: int = 100, **kwargs) -> list[dict]:
    """
    Discover all products from a Olive Young category page.

    Example:
        results = discover_by_category("https://oliveyoung.co.kr/s?k=headphones", limit=200)
    """
...
if __name__ == "__main__":
    ...
    sample_urls = [
        "https://www.oliveyoung.co.kr/product/sample-item-123456",
        # Add more Olive Young product URLs here
    ]
    results = track_prices(sample_urls)

    output_file = "olive-young_prices.json"
    ...
    # cat_results = discover_by_category("https://oliveyoung.co.kr/category/sample", limit=50)
